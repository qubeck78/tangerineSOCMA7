...
#
# Script generated by Vivado on Mon Apr 15 18:31:53 +0200 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : clockingSystem.sh
...
#
# Usage        : clockingSystem.sh
#                clockingSystem.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clockingSystem.sh [-reset_run]
#                clockingSystem.sh [-reset_log]
#                clockingSystem.sh [-help]
#
...
#                script (type 'clockingSystem.sh -help' for more information).
#
...
# script info
echo -e "clockingSystem.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clockingSystem.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.clockingSystem xil_defaultlib.glbl -o clockingSystem_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./clockingSystem_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key clockingSystem_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc clockingSystem_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./clockingSystem.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: clockingSystem.sh [-help]\n\
Usage: clockingSystem.sh [-step]\n\
Usage: clockingSystem.sh [-lib_map_path]\n\
Usage: clockingSystem.sh [-reset_run]\n\
Usage: clockingSystem.sh [-reset_log]\n\
Usage: clockingSystem.sh [-keep_index]\n\
Usage: clockingSystem.sh [-noclean_files]\n\n\
