...
#
# Script generated by Vivado on Tue Apr 16 22:37:09 +0200 2024
...
#
# Usage        : migDDR3.sh
#                migDDR3.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                migDDR3.sh [-reset_run]
#                migDDR3.sh [-reset_log]
#                migDDR3.sh [-help]
#
...
# script info
echo -e "migDDR3.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./migDDR3.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot migDDR3 xil_defaultlib.migDDR3 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim migDDR3 -key {Behavioral:sim_1:Functional:migDDR3} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb migDDR3.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./migDDR3.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: migDDR3.sh [-help]\n\
Usage: migDDR3.sh [-step]\n\
Usage: migDDR3.sh [-lib_map_path]\n\
Usage: migDDR3.sh [-reset_run]\n\
Usage: migDDR3.sh [-reset_log]\n\
Usage: migDDR3.sh [-keep_index]\n\
Usage: migDDR3.sh [-noclean_files]\n\n\
