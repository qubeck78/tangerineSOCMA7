...
#
# Script generated by Vivado on Mon Apr 15 18:32:53 +0200 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : clockingHDMI.sh
...
#
# Usage        : clockingHDMI.sh
#                clockingHDMI.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clockingHDMI.sh [-reset_run]
#                clockingHDMI.sh [-reset_log]
#                clockingHDMI.sh [-help]
#
...
# script info
echo -e "clockingHDMI.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clockingHDMI.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clockingHDMI xil_defaultlib.clockingHDMI xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim clockingHDMI -key {Behavioral:sim_1:Functional:clockingHDMI} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb clockingHDMI.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./clockingHDMI.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: clockingHDMI.sh [-help]\n\
Usage: clockingHDMI.sh [-step]\n\
Usage: clockingHDMI.sh [-lib_map_path]\n\
Usage: clockingHDMI.sh [-reset_run]\n\
Usage: clockingHDMI.sh [-reset_log]\n\
Usage: clockingHDMI.sh [-keep_index]\n\
Usage: clockingHDMI.sh [-noclean_files]\n\n\
